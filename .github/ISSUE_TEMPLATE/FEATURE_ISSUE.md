...
about: Want us to add any features to MNIST_synthetic?
title: 'enh: '
labels: enhancement
assignees: ''
...
<!--
  Hi! Thanks for considering to file a feature request with MNIST_synthetic. Please take the time to
...
<!--
  Why do you want to see this feature in MNIST_synthetic? What use cases does it support?
-->
